    ...
    <div class="content">
      ...
      <div class="footer">
        ...
        <div class="version">
          ...
          <span class="body-md" :class="{ 'force-opacity': showLabels }">Player v11.0.8</span>
        </div>
      </div>
    </div>
  </div>
...
<script>
import NavigationBar from '@/components/mobile/NavigationBarAccount';
...
.field-group {
  position: relative;
  padding: 12px $mobile-gutter;
  border-bottom: 1px solid $grey-cool-20;
